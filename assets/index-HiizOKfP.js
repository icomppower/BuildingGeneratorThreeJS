...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ns(e,t,n){let r=new Float32Array(ys),i=new W(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:ys,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Is(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ps(){return new Ca({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Is(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(){return new Ca({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Is(),fragmentShader:`
	...
	`}var Ls=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var cl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ll(e,t){let n=cl[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ul=new W;function dl(){return K.getLuminanceCoefficients(ul),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ul.x.toFixed(4)}, ${ul.y.toFixed(4)}, ${ul.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=el(i,i.VERTEX_SHADER,y),S=el(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=ol(i,x,`vertex`),n=ol(i,S,`fragment`);B(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
@font-face {
...
}`;function rd(e){let t=document.createElement(`style`);t.innerHTML=e;let n=document.querySelector(`head link[rel=stylesheet], head style`);n?document.head.insertBefore(t,n):document.head.appendChild(t)}var id=!1,ad=class e{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:r,title:i=`Controls`,closeFolders:a=!1,injectStyles:o=!0,touchStyles:s=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement(`div`),this.domElement.classList.add(`lil-gui`),this.$title=document.createElement(`button`),this.$title.classList.add(`title`),this.$title.setAttribute(`aria-expanded`,!0),this.$title.addEventListener(`click`,()=>this.openAnimated(this._closed)),this.$title.addEventListener(`touchstart`,()=>{},{passive:!0}),this.$children=document.createElement(`div`),this.$children.classList.add(`children`),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(i),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add(`root`),s&&this.domElement.classList.add(`allow-touch-styles`),!id&&o&&(rd(nd),id=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add(`autoPlace`),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty(`--width`,r+`px`),this._closeFolders=a}add(e,t,n,r,i){if(Object(n)===n)return new ed(this,e,t,n);let a=e[t];switch(typeof a){case`number`:return new $u(this,e,t,n,r,i);case`boolean`:return new Gu(this,e,t);case`string`:return new td(this,e,t);case`function`:return new Qu(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,a)}addColor(e,t,n=1){return new Zu(this,e,t,n)}addFolder(t){let n=new e({parent:this,title:t});return this.root._closeFolders&&n.close(),n}load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{t instanceof Qu||t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}save(e=!0){let t={controllers:{},folders:{}};return this.controllers.forEach(e=>{if(!(e instanceof Qu)){if(e._name in t.controllers)throw Error(`Cannot save GUI with duplicate property "${e._name}"`);t.controllers[e._name]=e.save()}}),e&&this.folders.forEach(e=>{if(e._title in t.folders)throw Error(`Cannot save GUI with duplicate folder "${e._title}"`);t.folders[e._title]=e.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute(`aria-expanded`,!this._closed),this.domElement.classList.toggle(`closed`,this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?`none`:``,this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute(`aria-expanded`,!this._closed),requestAnimationFrame(()=>{let t=this.$children.clientHeight;this.$children.style.height=t+`px`,this.domElement.classList.add(`transition`);let n=e=>{e.target===this.$children&&(this.$children.style.height=``,this.domElement.classList.remove(`transition`),this.$children.removeEventListener(`transitionend`,n))};this.$children.addEventListener(`transitionend`,n);let r=e?this.$children.scrollHeight:0;this.domElement.classList.toggle(`closed`,!e),requestAnimationFrame(()=>{this.$children.style.height=r+`px`})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(e=>e.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}};function od(){return{floor:6,length:7,width:3,acUnit:.724,roofProbability:.512,clothlineProbability:.709,windowType:.75,windowOpenAmount:0,curtainClose:0,closedOpenStore:.598,roofOnStore:.594,objectOnGround:1,storeSign:.748,objectOnRoof:.835,randomise:0}}function sd(e,t){let n=Math.imul(e|0,2654435761)^Math.imul((t|0)+374761393,2246822519);return n=Math.imul(n^n>>>16,2146121005),n=Math.imul(n^n>>>15,2221713035),n^=n>>>16,n>>>0}function cd(e,t){return sd(e,t)/4294967296}function ld(e,t,n){return sd(sd(e,n),t)/4294967296}function ud(e,t,n){return cd(t,n)<e}function dd(e,t,n,r){let i=e+Math.floor(cd(n,r)*(t-e+1));return Math.min(i,t)}function fd(e,t,n,r,i){return e+ld(n,r,100+i)*(t-e)}var Q=(e,t,n)=>`COL[${e}][${(t%n.count(e)+n.count(e))%n.count(e)}]`,pd=e=>`OBJ[${e}]`;function md(e,t){let n=[],r=[];return e.forEach((e,i)=>(t(e,i)?n:r).push(e)),[n,r]}var hd=new jt,gd=new ln;function _d(e,t,n,r=0,i=1,a=1,o=1,s){gd.set(0,0,r),hd.setFromEuler(gd);let c=new q().compose(new W(e,t,n),hd,new W(i,a,o));return s&&c.multiply(s),c}var vd=_d(0,0,0,Math.PI/2,-1,1,1);function yd(e,t,n){let r=[],i=e.randomise,a=e.floor,o=(e,n,i,a,o,s=0,c=1,l=1,u=1,d)=>{let f=n.x+i;r.push({key:e,local:_d(f,t.yShift+a,n.z+o,s,c,l,u,d),ox:f})},s=[];for(let e=1;e<=a-1;e++)for(let n=0;n<=t.n-1;n++)s.push({x:-t.n/2+n,z:-a/2+e});if(s.length===0)return r;let c=2*e.windowOpenAmount,l=5*e.curtainClose;s.forEach((e,r)=>{let a=dd(0,100,r,i);o(Q(`wall.001`,a,n),e,0,0,0),o(Q(`window guard.001`,a,n),e,0,0,0),o(Q(`ROOMS.001`,dd(t.roomsPick[0],t.roomsPick[1],r,i),n),e,0,0,0);let s=dd(t.curtainPick[0],t.curtainPick[1],r,i),c=1+fd(0,1,r,41,0)*(l-1),u=1+fd(0,1,r,32,0)*(l-1);o(Q(`CURTAINS.001`,s,n),e,.079,.038,.5,0,c,1,1),o(Q(`CURTAINS.001`,s,n),e,.919,.038,.5,0,-u,1,1)});let[u]=md(s,(t,n)=>ud(e.roofProbability,n,i));u.forEach((e,r)=>o(Q(`roof.002`,dd(t.awningPick[0],t.awningPick[1],r,i),n),e,0,0,0));let[d,f]=t.acFirstFloorCut?md(s,e=>e.z>-(a+1)/2+2):[s,[]],[p,m]=md(d,(t,n)=>ud(e.acUnit,n,i));p.forEach((e,r)=>{let a=dd(t.acPick[0],t.acPick[1],r,i)%n.count(`ac.001`),s=fd(-.175,.175,a,0,0),c=new q().makeTranslation(.5+s,0,.15);o(Q(`ac.001`,a,n),e,0,0,0,0,1,1,1,c),o(Q(`AC WIRE.001`,r,n),e,0,0,0)});let[h]=md(p,(t,n)=>ud(e.clothlineProbability,n,i));h.forEach((e,r)=>o(Q(`cloth lines.001`,dd(t.clothPick[0],t.clothPick[1],r,i),n),e,0,0,0));let[g]=md([...m,...f],(t,n)=>ud(e.clothlineProbability,n,i)),[_,v]=md(g,(e,t)=>ud(.5,t,i));_.forEach((e,t)=>o(Q(`cloth lines WITH CLOTHES.001`,t,n),e,0,0,0)),v.forEach((e,t)=>o(Q(`cloth lines.001`,t,n),e,0,0,0));let[y,b]=md(s,(t,n)=>ud(e.windowType,n,0)),x=(t,r,a,s)=>{t.forEach((t,l)=>{o(r,t,0,0,0),o(Q(s,dd(0,100,l,i),n),t,0,0,0);let u=fd(0,c,l,i,2),d=fd(0,-e.windowOpenAmount,l,i,2);o(a,t,.921,.011,.518,u,-1,1,1),o(a,t,.494,.011,.518,u,-1,1,1),o(a,t,.506,.011,.518,d,1,1,1),o(a,t,.079,.011,.518,d,1,1,1)})};return x(y,pd(`steel frame.001`),pd(`steel window.001`),`steel window top preset.001`),x(b,pd(`wood frame.001`),pd(`wood window.001`),`window wood top preset.001`),r}function bd(e,t,n,r,i){let a=[],o=e.floor/2,s=t/2,c=r?vd:void 0,l=(e,t,n,r)=>a.push({key:e,local:_d(t,0,n,0,1,1,1,r),ox:t});for(let e=0;e<=t-1;e++)l(Q(n,e,i),-t/2+e,o);l(Q(`roofcorner`,0,i),s,o,c);for(let t=1;t<=e.floor-1;t++)l(Q(`corner`,0,i),s,-e.floor/2+t,c);return l(Q(`ground_corner`,0,i),s,-e.floor/2,c),a}function xd(e,t){let n=[],r=e.randomise,i=-e.floor/2,a=[];for(let t=0;t<=e.length-1;t++)a.push({x:-e.length/2+t,z:i});let o=(e,t)=>n.push({key:e,local:_d(t.x,0,t.z),ox:t.x}),s=a.map((e,t)=>({wire:dd(0,25,t,r),sign:dd(0,25,t,r),hanging:dd(0,25,t,r),lights:dd(0,25,t,r),propFront:dd(0,25,t,r),propStore:dd(0,25,t,r)}));a.forEach((e,n)=>{o(Q(`groud_front`,n,t),e),o(Q(`wire`,s[n].wire,t),e)});let c=a.map((t,n)=>ud(e.closedOpenStore,n,r)),l=a.map((e,t)=>({c:e,i:t})),u=l.filter(e=>c[e.i]),d=l.filter(e=>!c[e.i]);return u.forEach(({c:n,i},a)=>{o(Q(`storefront`,i,t),n),o(Q(`storeinside`,i,t),n),o(Q(`lightsground`,s[i].lights,t),n),o(Q(`prop_store`,s[i].propStore,t),n),ud(e.storeSign,a,r)&&(o(Q(`store_sign`,s[i].sign,t),n),o(Q(`store_sign_hanging`,s[i].hanging,t),n)),ud(e.roofOnStore,a,r)&&o(pd(`store_roof`),n),ud(e.objectOnGround,a,r)&&o(Q(`prop_front`,s[i].propFront,t),n)}),d.forEach(({c:n,i},a)=>{o(Q(`shutter`,i,t),n),ud(e.storeSign,a,0)&&o(Q(`old store_sign`,i,t),n),ud(e.objectOnGround,a,r)&&o(Q(`prop_groud`,i,t),n)}),n}function Sd(e,t){let n=[],r=e.randomise,i=-e.floor/2;for(let a=0;a<=e.length-1;a++){let o=-e.length/2+a,s=e=>n.push({key:e,local:_d(o,0,i),ox:o});s(Q(`ground_back`,dd(0,100,a,r),t)),s(Q(`wire`,dd(0,25,a,r),t)),s(Q(`eletricarea`,dd(0,31,a,r),t))}return n}function Cd(e,t){let n=[],r=e.randomise,i=-e.floor/2,a=[];for(let t=0;t<=e.width-1;t++)a.push({x:-e.width/2+t,z:i});return a.forEach((e,i)=>{n.push({key:Q(`groud side wall`,dd(0,100,i,r),t),local:_d(e.x,0,e.z),ox:e.x})}),a.forEach((i,a)=>{ud(e.objectOnGround,a,r)&&n.push({key:Q(`prop_groud`,dd(0,54,a,r),t),local:_d(i.x,0,i.z),ox:i.x})}),n}function wd(e,t){let n=[],r=e.randomise,i=new q().makeTranslation(0,-.6,e.floor/2+.05),a=(e,t,n)=>i.clone().multiply(_d(e,t,0,n)),o=a(0,e.width/2+.6,Math.PI),s=a(0,-e.width/2+.6,0),c=a(e.length/2,.6,Math.PI/2),l=a(-e.length/2,.6,Math.PI*1.5),u=(e,t)=>{for(let r of t)n.push({key:r.key,matrix:e.clone().multiply(r.local)})},d=yd(e,{n:e.length,yShift:-.5,roomsPick:[0,80],awningPick:[45,125],curtainPick:[0,101],acPick:[50,100],clothPick:[0,113],acFirstFloorCut:!0},t),f=bd(e,e.length,`guardrail front`,!1,t),p=bd(e,e.length,`guardrail back`,!1,t);u(o,d),u(o,f),u(o,xd(e,t)),u(s,d),u(s,p),u(s,Sd(e,t));let m=yd(e,{n:e.width,yShift:-.1,roomsPick:[0,101],awningPick:[0,113],curtainPick:[0,164],acPick:[50,200],clothPick:[0,96],acFirstFloorCut:!1},t),h=bd(e,e.width,`guardrailside`,!0,t),g=Cd(e,t);u(c,m),u(c,h),u(c,g);let _=-(e.width+1)/2+1.45;u(l,m.filter(e=>e.ox>_));for(let n=1;n<=e.floor-1;n++){let r={x:-e.width/2,z:-e.floor/2+n};u(l,[{key:Q(`side_wall`,0,t),local:_d(r.x,0,r.z),ox:r.x}])}u(l,h),u(l,g);let v=e.floor/2+.1,y=[];for(let t=0;t<e.width;t++)for(let n=0;n<e.length;n++)y.push({x:-e.length/2+.5+n,z:.6-e.width/2+.5+t});let b=(e,t)=>n.push({key:e,matrix:i.clone().multiply(_d(t.x,t.z,v))});y.forEach(e=>{for(let n=0;n<t.count(`roof`);n++)b(`COL[roof][${n}]`,e)});let[x]=md(y,(t,n)=>ud(e.objectOnRoof,n,0));return x.forEach((e,n)=>b(Q(`roof_prop`,dd(0,120,n,r),t),e)),n}function Td(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Ed(e){let t=new Map,n=new Map,r=e.clone();return Dd(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Dd(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Dd(e.children[r],t.children[r],n)}var Od=class extends eo{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Pd(e)}),this.register(function(e){return new Fd(e)}),this.register(function(e){return new Wd(e)}),this.register(function(e){return new Gd(e)}),this.register(function(e){return new Kd(e)}),this.register(function(e){return new Ld(e)}),this.register(function(e){return new Rd(e)}),this.register(function(e){return new zd(e)}),this.register(function(e){return new Bd(e)}),this.register(function(e){return new Nd(e)}),this.register(function(e){return new Vd(e)}),this.register(function(e){return new Id(e)}),this.register(function(e){return new Ud(e)}),this.register(function(e){return new Hd(e)}),this.register(function(e){return new jd(e)}),this.register(function(e){return new qd(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new qd(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Jd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=ko.extractUrlBase(e);a=ko.resolveURL(t,this.path)}else a=ko.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new ro(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Yd){try{a[$.KHR_BINARY_GLTF]=new Qd(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Tf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new Md;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new $d(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new ef;break;case $.KHR_MESH_QUANTIZATION:a[t]=new tf;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function kd(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Ad(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},jd=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new J(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ue);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Do(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new wo(s),o.distance=c;break;case`spot`:o=new So(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),_f(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},Md=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return Wr}extendParams(e,t,n){let r=[];e.color=new J(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ue),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,He))}return Promise.all(r)}},Nd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Pd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new U(e,e)}return Promise.all(r)}},Fd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},Id=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Ld=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new J(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ue)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,He)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Rd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},zd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new J().setRGB(i[0],i[1],i[2],Ue),Promise.all(r)}},Bd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Vd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new J().setRGB(i[0],i[1],i[2],Ue),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,He)),Promise.all(r)}},Hd=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Ud=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Ad(this.parser,e,this.name)===null?null:Ea}extendMaterialParams(e,t){let n=Ad(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Wd=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Gd=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Kd=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},qd=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},Jd=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==of.TRIANGLES&&e.mode!==of.TRIANGLE_STRIP&&e.mode!==of.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new q,n=new W,a=new jt,s=new W(1,1,1),c=new Oi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new bi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);En.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Yd=`glTF`,Xd=12,Zd={JSON:1313821514,BIN:5130562},Qd=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Xd),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Yd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Xd,i=new DataView(e,Xd),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Zd.JSON){let r=new Uint8Array(e,Xd+a,t);this.content=n.decode(r)}else if(r===Zd.BIN){let n=Xd+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},$d=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=df[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=df[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=sf[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ue,n)})})}},ef=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},tf=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},nf=class extends Fa{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},rf=new jt,af=class extends nf{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return rf.fromArray(i).normalize().toArray(i),i}},of={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},sf={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},cf={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},lf={33071:i,33648:a,10497:r},uf={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},df={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},ff={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},pf={CUBICSPLINE:void 0,LINEAR:Ie,STEP:F},mf={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function hf(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Ta({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function gf(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function _f(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function vf(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function yf(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function bf(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+xf(n.attributes):e.indices+`:`+xf(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+xf(e.targets[n]);return t}function xf(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function Sf(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function Cf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var wf=new q,Tf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new kd,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new oo(this.options.manager):this.textureLoader=new Mo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new ro(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return gf(i,a,r),_f(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(ko.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=uf[r.type],t=sf[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new hr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=uf[r.type],o=sf[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new jr(f,u/s),t.cache.add(n,c)),p=new Nr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new hr(f,a,d);if(r.sparse!==void 0){let t=uf.SCALAR,n=sf[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new hr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=cf[n.magFilter]||1006,t.minFilter=cf[n.minFilter]||1008,t.wrapS=lf[n.wrapS]||1e3,t.wrapT=lf[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new qt(e);t.needsUpdate=!0,n(t)}),t.load(ko.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),_f(e,a),e.userData.mimeType=a.mimeType||Cf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Zi,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Li,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Ta}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new J(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ue),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,He)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||mf.OPAQUE;if(l===mf.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===mf.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new U(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Wr){let e=i.emissiveFactor;o.emissive=new J().setRGB(e[0],e[1],e[2],Ue)}return i.emissiveTexture!==void 0&&a!==Wr&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,He)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),_f(n,i),t.associations.set(n,{materials:e}),i.extensions&&gf(r,n,i),n})}createUniqueName(e){let t=Xo.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Df(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=bf(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):Df(new Ar,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?hf(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===of.TRIANGLES||u.mode===of.TRIANGLE_STRIP||u.mode===of.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new mi(l,f):new ni(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===of.TRIANGLE_STRIP?d.geometry=Td(d.geometry,1):u.mode===of.TRIANGLE_FAN&&(d.geometry=Td(d.geometry,2));else if(u.mode===of.LINES)d=new Yi(l,f);else if(u.mode===of.LINE_STRIP)d=new Gi(l,f);else if(u.mode===of.LINE_LOOP)d=new Xi(l,f);else if(u.mode===of.POINTS)d=new na(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&yf(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),_f(d,i),u.extensions&&gf(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&gf(r,c[0],i),c[0];let l=new Dn;i.extensions&&gf(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new bo(At.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new To(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),_f(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new q;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new yi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new Ja(i,void 0,l);return _f(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,wf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new W().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new hi:t.length>1?new Dn:t.length===1?t[0]:new En,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),_f(o,i),i.extensions&&gf(n,o,i),i.matrix!==void 0){let e=new q;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Dn;n.name&&(i.name=r.createUniqueName(n.name)),_f(i,n),n.extensions&&gf(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Ed(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Fr||e instanceof qt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}ff[i.path]===ff.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(ff[i.path]){case ff.weights:l=Ua;break;case ff.rotation:l=Ga;break;case ff.translation:case ff.scale:l=qa;break;default:switch(n.itemSize){case 1:l=Ua;break;default:l=qa;break}break}let u=r.interpolation===void 0?Ie:pf[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+ff[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=Sf(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Ga?af:nf)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Ef(e,t,n){let r=t.attributes,i=new Zn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new W(t[0],t[1],t[2]),new W(a[0],a[1],a[2])),e.normalized){let t=Sf(sf[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new W,t=new W;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=Sf(sf[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Sr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Df(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=df[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return K.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`),_f(e,t),Ef(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:vf(e,t.targets,n)})}function Of(e,t,n=!1){let i=e.load(t);return i.flipY=!1,i.colorSpace=n?He:``,i.wrapS=i.wrapT=r,i}function kf(){let e=new oo;return{building:new Ta({name:`building`,map:Of(e,`./textures/Material_Base_color.png`,!0),normalMap:Of(e,`./textures/Material_Normal_OpenGL.png`),roughnessMap:Of(e,`./textures/Material_Roughness.png`),roughness:1,metalnessMap:Of(e,`./textures/Material_Metallic.png`),metalness:1,emissiveMap:Of(e,`./textures/Material_Emissive.png`,!0),emissive:new J(16777215),emissiveIntensity:1.4,side:2}),floor:new Ta({name:`floor`,map:Of(e,`./textures/floor_Base_color.png`,!0),normalMap:Of(e,`./textures/floor_Normal_OpenGL.png`),roughnessMap:Of(e,`./textures/floor_Roughness.png`),roughness:1,metalnessMap:Of(e,`./textures/floor_Metallic.png`),metalness:1,emissiveMap:Of(e,`./textures/floor_Base_Emissive.png`,!0),emissive:new J(16777215),emissiveIntensity:1,alphaMap:Of(e,`./textures/floor_alpha.png`),alphaTest:.5,side:2}),glass:new Ea({name:`glass`,color:10467524,roughness:.08,metalness:0,transparent:!0,opacity:.22,depthWrite:!1,side:2})}}var Af=new q().makeScale(-1,1,1),jf=class{parts=new Map;manifest;warned=new Set;mirrorCache=new Map;dryMaterials=new Map;materials;snowShellMaterial=null;mirroredGeometry(e){let t=this.mirrorCache.get(e);if(t)return t;t=e.clone();for(let e of[`position`,`normal`,`tangent`]){let n=t.getAttribute(e);if(n){for(let e=0;e<n.count;e++)n.setX(e,-n.getX(e));if(e===`tangent`&&n.itemSize===4)for(let e=0;e<n.count;e++)n.setW(e,-n.getW(e));n.needsUpdate=!0}}if(!t.index){let e=t.getAttribute(`position`).count,n=e>65535?new Uint32Array(e):new Uint16Array(e);for(let t=0;t<e;t++)n[t]=t;t.setIndex(new hr(n,1))}let n=t.index;for(let e=0;e+2<n.count;e+=3){let t=n.getX(e+1);n.setX(e+1,n.getX(e+2)),n.setX(e+2,t)}return n.needsUpdate=!0,t.computeBoundingSphere(),this.mirrorCache.set(e,t),t}count(e){return this.manifest.collections[e]?.children?.length||1}setFloorEmissive(e){let t=this.materials?.floor;t&&(t.emissiveIntensity=e);let n=t&&this.dryMaterials.get(t);n&&(n.emissiveIntensity=e)}async load(e,t){let[n,r]=await Promise.all([new Od().loadAsync(e),fetch(t).then(e=>e.json())]);this.manifest=r;let i=n.parser.json,a=n.parser.associations;for(let e of[...n.scene.children]){let t=a.get(e),n=t?.nodes===void 0?void 0:i.nodes?.[t.nodes]?.name;this.parts.set(n??e.name,e),e.updateMatrixWorld(!0)}let o=kf();this.materials=o,this.dryMaterials.set(o.building,o.building.clone()),this.dryMaterials.set(o.floor,o.floor.clone());let s=o.building;n.scene.traverse(e=>{let t=e;if(!t.isMesh)return;let n=(t.material?.name??``).toLowerCase(),r=s;for(let e of Object.keys(o))if(n.includes(e)){r=o[e];break}t.material=r})}buildGroup(e){let t=new Dn,n=new Map;for(let t of e){let e=n.get(t.key);e||n.set(t.key,e=[]),e.push(t.matrix)}let r=new Dn;r.name=`snowShell`,r.visible=!1;let i=new q;for(let[e,a]of n){let n=e.includes(`ROOMS`)||e.includes(`storeinside`),o=this.parts.get(e);if(!o){this.warned.has(e)||(this.warned.add(e),console.warn(`kit: missing part ${e}`));continue}o.traverse(s=>{let c=s;if(!c.isMesh)return;let l=new q().copy(o.matrixWorld).invert().multiply(c.matrixWorld),u=[],d=[];for(let e of a)i.copy(e).multiply(l),i.determinant()<0?d.push(i.clone().multiply(Af)):u.push(i.clone());for(let[i,a]of[[c.geometry,u],[d.length?this.mirroredGeometry(c.geometry):null,d]]){if(!i||a.length===0)continue;let o=c.material,s=new Oi(i,n?this.dryMaterials.get(o)??o:o,a.length);s.name=e,s.castShadow=!0,s.receiveShadow=!0;for(let e=0;e<a.length;e++)s.setMatrixAt(e,a[e]);if(s.instanceMatrix.needsUpdate=!0,t.add(s),this.snowShellMaterial&&!n&&(c.material===this.materials.building||c.material===this.materials.floor)){let e=new Oi(i,this.snowShellMaterial,a.length);e.instanceMatrix=s.instanceMatrix,e.castShadow=!1,e.receiveShadow=!0,r.add(e)}}})}return r.children.length&&t.add(r),t}},Mf=class extends In{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new ca;e.deleteAttribute(`uv`);let t=new Ta({side:1}),n=new Ta,r=new wo(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new ni(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Oi(e,n,6),o=new En;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new ni(e,Nf(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new ni(e,Nf(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new ni(e,Nf(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new ni(e,Nf(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new ni(e,Nf(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new ni(e,Nf(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Nf(e){return new Oa({color:0,emissive:16777215,emissiveIntensity:e})}var Pf=329226,Ff=new W(8,12,6).normalize(),If=new W(-9,5,-4).normalize(),Lf=new W(-6,8,-10).normalize(),Rf=class{key=new Do(16773597,3);fill=new Do(4877567,.6);rim=new So(16767392,120,50,Math.PI*.25,.4,1.2);ambient=new Oo(2240580,.4);settings={exposure:.5,envIntensity:.35,fog:!0,fogDensity:.006};scene;renderer;constructor(e,t){this.scene=e,this.renderer=t,e.background=new J(Pf),e.fog=new Fn(Pf,this.settings.fogDensity),e.environment=new Os(t).fromScene(new Mf,.04).texture,e.environmentIntensity=this.settings.envIntensity,t.shadowMap.enabled=!0,t.shadowMap.type=2,t.toneMappingExposure=this.settings.exposure;let n=this.key.shadow;this.key.castShadow=!0,n.mapSize.set(2048,2048),n.bias=-2e-4,n.normalBias=.02,e.add(this.key,this.key.target),e.add(this.fill),e.add(this.rim,this.rim.target),e.add(this.ambient)}frame(e){let t=Math.max(e.radius*2.4,20);this.key.position.copy(e.center).addScaledVector(Ff,t),this.key.target.position.copy(e.center),this.key.target.updateMatrixWorld(),this.fill.position.copy(e.center).addScaledVector(If,t),this.rim.position.copy(e.center).addScaledVector(Lf,t),this.rim.target.position.copy(e.center),this.rim.target.updateMatrixWorld(),this.rim.distance=t*2.4,this.rim.angle=Math.atan2(e.radius*1.5,t);let n=this.key.shadow.camera,r=e.radius*1.3;n.left=-r,n.right=r,n.top=r,n.bottom=-r,n.near=.5,n.far=t+e.radius*3,n.updateProjectionMatrix()}refresh(){this.renderer.toneMappingExposure=this.settings.exposure,this.scene.environmentIntensity=this.settings.envIntensity;let e=this.scene.fog;e&&(e.density=this.settings.fog?this.settings.fogDensity:0)}tick(){}addGui(e){let t=e.addFolder(`lighting`);t.add(this.settings,`exposure`,0,3,.01).name(`exposure`).onChange(e=>this.renderer.toneMappingExposure=e),t.add(this.key,`intensity`,0,8,.01).name(`key`),t.add(this.fill,`intensity`,0,4,.01).name(`fill`),t.add(this.rim,`intensity`,0,400,1).name(`rim`),t.add(this.settings,`envIntensity`,0,2,.01).name(`env / IBL`).onChange(e=>this.scene.environmentIntensity=e),t.add(this.settings,`fog`).name(`fog`).onChange(()=>this.refresh()),t.add(this.settings,`fogDensity`,0,.03,5e-4).name(`fog density`).onChange(()=>this.refresh()),t.close()}},zf={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},Bf=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Vf=new To(-1,1,1,-1,0,1),Hf=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new vr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new vr([0,2,0,0,2,0],2))}},Uf=class{constructor(e){this._mesh=new ni(Hf,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Vf)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Wf=class extends Bf{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ca?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ba.clone(e.uniforms),this.material=new Ca({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Uf(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Gf=class extends Bf{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Kf=class extends Bf{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},qf=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Xt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Wf(zf),this.copyPass.material.blending=0,this.timer=new Lo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Gf!==void 0&&(r instanceof Gf?n=!0:r instanceof Kf&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Jf=class extends Bf{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Yf={name:`BokehShader`,defines:{DEPTH_PACKING:1,PERSPECTIVE_CAMERA:1},uniforms:{tColor:{value:null},tDepth:{value:null},focus:{value:1},aspect:{value:1},aperture:{value:.025},maxblur:{value:.01},nearClip:{value:1},farClip:{value:1e3}},vertexShader:`
		...
		}`},Xf=class extends Bf{constructor(e,t,n){super(),this.scene=e,this.camera=t;let r=n.focus===void 0?1:n.focus,i=n.aperture===void 0?.025:n.aperture,a=n.maxblur===void 0?1:n.maxblur;this._renderTargetDepth=new Xt(1,1,{minFilter:o,magFilter:o,type:y}),this._renderTargetDepth.texture.name=`BokehPass.depth`,this._materialDepth=new ka,this._materialDepth.depthPacking=Ve,this._materialDepth.blending=0;let s=ba.clone(Yf.uniforms);s.tDepth.value=this._renderTargetDepth.texture,s.focus.value=r,s.aspect.value=t.aspect,s.aperture.value=i,s.maxblur.value=a,s.nearClip.value=t.near,s.farClip.value=t.far,this.materialBokeh=new Ca({defines:Object.assign({},Yf.defines),uniforms:s,vertexShader:Yf.vertexShader,fragmentShader:Yf.fragmentShader}),this.uniforms=s,this._fsQuad=new Uf(this.materialBokeh),this._oldClearColor=new J}render(e,t,n){this.scene.overrideMaterial=this._materialDepth,e.getClearColor(this._oldClearColor);let r=e.getClearAlpha(),i=e.autoClear;e.autoClear=!1,e.setClearColor(16777215),e.setClearAlpha(1),e.setRenderTarget(this._renderTargetDepth),e.clear(),e.render(this.scene,this.camera),this.uniforms.tColor.value=n.texture,this.uniforms.nearClip.value=this.camera.near,this.uniforms.farClip.value=this.camera.far,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),e.clear(),this._fsQuad.render(e)),this.scene.overrideMaterial=null,e.setClearColor(this._oldClearColor),e.setClearAlpha(r),e.autoClear=i}setSize(e,t){this.materialBokeh.uniforms.aspect.value=e/t,this._renderTargetDepth.setSize(e,t)}dispose(){this._renderTargetDepth.dispose(),this._materialDepth.dispose(),this.materialBokeh.dispose(),this._fsQuad.dispose()}},Zf={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new J(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Qf.BlurDirectionX=new U(1,0),Qf.BlurDirectionY=new U(0,1);var $f={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ep=class extends Bf{constructor(){super(),this.isOutputPass=!0,this.uniforms=ba.clone($f.uniforms),this.material=new wa({name:$f.name,uniforms:this.uniforms,vertexShader:$f.vertexShader,fragmentShader:$f.fragmentShader}),this._fsQuad=new Uf(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},tp={uniforms:{tDiffuse:{value:null},uTime:{value:0},uVignette:{value:.15},uVignetteSize:{value:.4},uGrain:{value:0},uChroma:{value:.0025},uContrast:{value:1},uSaturation:{value:1}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},np=class{composer;bokeh;bloom;grade;constructor(e,t,n){let r=e.getDrawingBufferSize(new U),i=new Xt(r.x,r.y,{type:y,samples:4});this.composer=new qf(e,i),this.composer.addPass(new Jf(t,n)),this.bokeh=new Xf(t,n,{focus:9.7,aperture:.0012,maxblur:.005}),this.bokeh.enabled=!1,this.composer.addPass(this.bokeh),this.bloom=new Qf(new U(r.x,r.y),.04,.7,.62),this.composer.addPass(this.bloom),this.composer.addPass(new ep),this.grade=new Wf(tp),this.composer.addPass(this.grade)}get bokehUniforms(){return this.bokeh.uniforms}get gradeUniforms(){return this.grade.uniforms}setSize(e,t){this.composer.setSize(e,t),this.bloom.setSize(e,t)}render(e){this.gradeUniforms.uTime.value+=e,this.composer.render()}};function rp(e){let{camera:t,shared:n,maxCount:r=3e4}=e,i=new Ao,a=new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),o=new Float32Array([0,0,1,0,1,1,0,1]);i.setAttribute(`position`,new hr(a,3)),i.setAttribute(`uv`,new hr(o,2)),i.setIndex([0,1,2,0,2,3]);let s=new Float32Array(r*3),c=new Float32Array(r);for(let e=0;e<r;e++)s[e*3+0]=Math.random(),s[e*3+1]=Math.random(),s[e*3+2]=Math.random(),c[e]=Math.random();i.setAttribute(`aSeed`,new bi(s,3)),i.setAttribute(`aRand`,new bi(c,1));let l={uTime:n.uTime,uWind:n.uWind,uCameraPos:{value:new W},uVolume:{value:new W(50,40,50)},uSpeed:{value:3.2},uSize:{value:.07},uSway:{value:.5},uOpacity:{value:.9},uColor:{value:new J(16777215)}},u=new Ca({uniforms:l,transparent:!0,depthWrite:!1,blending:1,vertexShader:`
      uniform float uTime;
      uniform vec3  uWind;
    ...
    `}),d=new ni(i,u);return d.frustumCulled=!1,i.instanceCount=Math.floor(r*.5),{mesh:d,material:u,uniforms:l,maxCount:r,update(){l.uCameraPos.value.copy(t.position)},setDensity(e){i.instanceCount=Math.max(1,Math.floor(At.clamp(e,0,1)*r))}}}function ip(e){return{uTime:e,uSnowSeed:{value:new U(3,7)},uSnowScale:{value:.6},uSnowHeightVar:{value:.35},uSnowCoverage:{value:.7},uSnowEdge:{value:.15},uSnowThickness:{value:.01},uSnowFlatThreshold:{value:.35},uSnowColor:{value:new J(15397375)},uSnowRoughness:{value:.85},uSnowSparkle:{value:.5},uSnowSparkleScale:{value:120},uSnowBump:{value:.4},uSnowBumpScale:{value:3}}}var ap=`
...
`;function op(e){let t=new Ta({color:16777215,roughness:.85,metalness:0,side:2,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});return t.onBeforeCompile=t=>{Object.assign(t.uniforms,e),t.vertexShader=t.vertexShader.replace(`#include <common>`,`#include <common>
`+ap).replace(`#include <beginnormal_vertex>`,`#include <beginnormal_vertex>
        #ifdef USE_INSTANCING
          mat3 snowNMat = mat3(modelMatrix) * mat3(instanceMatrix);
        #else
          mat3 snowNMat = mat3(modelMatrix);
        #endif
        vSnowWorldN = normalize(snowNMat * objectNormal);`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
        #ifdef USE_INSTANCING
        ...
        transformed += normalize(objectNormal) * (uSnowThickness * snowAccumV / snowMs);`),t.fragmentShader=t.fragmentShader.replace(`#include <common>`,`#include <common>
`+ap).replace(`#include <map_fragment>`,`#include <map_fragment>
        ...
        diffuseColor.rgb = uSnowColor * snowShade + snowSparkle;`).replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
        roughnessFactor = uSnowRoughness;
        roughnessFactor = mix(roughnessFactor, 0.08, snowSparkle);`).replace(`#include <normal_fragment_maps>`,`#include <normal_fragment_maps>
        vec3 snowN = snowReliefNormal(vSnowWorldP.xz);
        vec3 snowView = normalize((viewMatrix * vec4(snowN, 0.0)).xyz);
        normal = normalize(mix(normal, snowView, clamp(snowAmt * 1.5, 0.0, 1.0)));`)},t.customProgramCacheKey=()=>`snow-shell-v1`,t}function sp(e){let{camera:t,shared:n,maxCount:r=3e4}=e,i=new Ao,a=new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),o=new Float32Array([0,0,1,0,1,1,0,1]);i.setAttribute(`position`,new hr(a,3)),i.setAttribute(`uv`,new hr(o,2)),i.setIndex([0,1,2,0,2,3]);let s=new Float32Array(r*3),c=new Float32Array(r);for(let e=0;e<r;e++)s[e*3+0]=Math.random(),s[e*3+1]=Math.random(),s[e*3+2]=Math.random(),c[e]=Math.random();i.setAttribute(`aSeed`,new bi(s,3)),i.setAttribute(`aRand`,new bi(c,1));let l={uTime:n.uTime,uWind:n.uWind,uLightning:n.uLightning,uCameraPos:{value:new W},uVolume:{value:new W(50,40,50)},uSpeed:{value:22},uLength:{value:1.4},uWidth:{value:.012},uOpacity:{value:.5},uColor:{value:new J(11843775)}},u=new Ca({uniforms:l,transparent:!0,depthWrite:!1,blending:1,vertexShader:`
      uniform float uTime;
      uniform vec3  uWind;
      uniform vec3  uCameraPos;
      uniform vec3  uVolume;
    ...
    `}),d=new ni(i,u);return d.frustumCulled=!1,i.instanceCount=Math.floor(r*.4),{mesh:d,material:u,uniforms:l,maxCount:r,update(){l.uCameraPos.value.copy(t.position)},setDensity(e){i.instanceCount=Math.max(1,Math.floor(At.clamp(e,0,1)*r))}}}function cp(e,t){return{uTime:e,uWind:t,uWet:{value:0},uWetness:{value:.85},uTopPuddle:{value:.7},uFlatThreshold:{value:.65},uDropletAmount:{value:.6},uDropletScale:{value:14},uWaterDarkness:{value:.45},uPuddleRoughness:{value:.05},uRainRipple:{value:.05},uRippleScale:{value:12},uRippleSpeed:{value:1.3},uRippleDensity:{value:.2},uPuddleScale:{value:.35},uPuddleHeightVar:{value:.6},uPuddleSeed:{value:new U(13.7,4.2)},uPuddleCoverage:{value:.6},uPuddleEdge:{value:.1}}}var lp=`
...
`;function up(e,t){e.onBeforeCompile=e=>{Object.assign(e.uniforms,t),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
varying vec3 vWetWorldN;
varying vec3 vWetWorldP;`).replace(`#include <beginnormal_vertex>`,`#include <beginnormal_vertex>
        #ifdef USE_INSTANCING
          mat3 wetNMat = mat3(modelMatrix) * mat3(instanceMatrix);
        #else
          mat3 wetNMat = mat3(modelMatrix);
        #endif
        vWetWorldN = normalize(wetNMat * objectNormal);`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
        #ifdef USE_INSTANCING
          vec4 wetWP = modelMatrix * instanceMatrix * vec4(transformed, 1.0);
        #else
          vec4 wetWP = modelMatrix * vec4(transformed, 1.0);
        #endif
        vWetWorldP = wetWP.xyz;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
`+lp).replace(`#include <map_fragment>`,`#include <map_fragment>
        ...
        normal = normalize(mix(normal, rView, topMask));`)},e.customProgramCacheKey=()=>`wet-building-v2`,e.needsUpdate=!0}var dp=document.getElementById(`app`),fp=new xu({antialias:!0,powerPreference:`high-performance`,logarithmicDepthBuffer:!0});fp.setPixelRatio(Math.min(window.devicePixelRatio,2)),fp.setSize(innerWidth,innerHeight),fp.toneMapping=4,fp.toneMappingExposure=1.15,fp.outputColorSpace=He,dp.appendChild(fp.domElement);var pp=new In,mp=new bo(30,innerWidth/innerHeight,.5,600);mp.position.set(12,7,14);var hp=new ju(mp,fp.domElement);hp.target.set(0,3.5,0),hp.enableDamping=!0,hp.dampingFactor=.06,hp.maxPolarAngle=Math.PI*.54,hp.minDistance=3,hp.maxDistance=120;var gp=new Rf(pp,fp),_p=new ni(new ma(600,600),new Ta({color:4210752,roughness:1,metalness:1}));_p.rotation.x=-Math.PI/2,_p.receiveShadow=!0,pp.add(_p);var vp=new Dn;vp.rotation.set(-Math.PI/2,0,Math.PI),pp.add(vp);var yp=new jf,bp=od(),xp=null,Sp={uTime:{value:0},uWind:{value:new W(2,0,1)}},Cp=ip(Sp.uTime);yp.snowShellMaterial=op(Cp);var wp=rp({camera:mp,shared:Sp});wp.mesh.visible=!1,wp.material.depthTest=!1,wp.mesh.renderOrder=10,pp.add(wp.mesh);var Tp={enabled:!1,density:.5},Ep={strength:2,direction:20};function Dp(){let e=Ep.direction*Math.PI/180;Sp.uWind.value.set(Math.cos(e)*Ep.strength,0,Math.sin(e)*Ep.strength)}Dp();function Op(e){e&&Mp.enabled&&(Mp.enabled=!1,Fp(!1)),wp.mesh.visible=e;let t=xp?.getObjectByName(`snowShell`);t&&(t.visible=e),mm.controllersRecursive().forEach(e=>e.updateDisplay())}var kp={uTime:{value:0},uWind:{value:new W(3,0,1)},uLightning:{value:0}},Ap=cp(kp.uTime,kp.uWind),jp=sp({camera:mp,shared:kp});jp.mesh.visible=!1,jp.material.depthTest=!1,jp.mesh.renderOrder=10,pp.add(jp.mesh);var Mp={enabled:!1,density:.4},Np={strength:3,direction:20};function Pp(){let e=Np.direction*Math.PI/180;kp.uWind.value.set(Math.cos(e)*Np.strength,0,Math.sin(e)*Np.strength)}Pp();function Fp(e){e&&Tp.enabled&&(Tp.enabled=!1,Op(!1)),jp.mesh.visible=e,Ap.uWet.value=+!!e,mm.controllersRecursive().forEach(e=>e.updateDisplay())}function Ip(){let e=bp.floor+.4;return{center:new W(0,e/2,0),radius:.5*Math.hypot(bp.length,bp.width,e)}}var Lp=`off`,Rp=new Map,zp=new Da({side:2}),Bp={key:3,fill:.6,rim:120,ambColor:2240580,amb:.4};function Vp(e){Lp!==`albedo`&&Lp!==`normals`||e.traverse(e=>{let t=e;if(!t.isMesh)return;if(Lp===`normals`){t.material=zp;return}let n=t.material,r=Rp.get(n);r||(r=new Wr({map:n.map??null,color:n.map?16777215:n.color?.getHex()??16777215,side:2,transparent:n.transparent,opacity:n.opacity,alphaTest:n.alphaTest}),Rp.set(n,r)),t.material=r})}function Hp(){Lp===`uniform`?(gp.key.intensity=0,gp.fill.intensity=0,gp.rim.intensity=0,gp.ambient.color.set(16777215),gp.ambient.intensity=3,pp.environmentIntensity=0,pp.fog=null):(gp.key.intensity=Bp.key,gp.fill.intensity=Bp.fill,gp.rim.intensity=Bp.rim,gp.ambient.color.set(Bp.ambColor),gp.ambient.intensity=Bp.amb,gp.refresh())}function Up(){xp&&(vp.remove(xp),xp.traverse(e=>{let t=e;t.isInstancedMesh&&t.dispose?.()})),xp=yp.buildGroup(wd(bp,yp)),Vp(xp),vp.add(xp),Op(Tp.enabled),gp.frame(Ip())}var Wp={enabled:!1},Gp=new Qo,Kp=new U,qp=!1,Jp=new Map,Yp=new Yi(new Ar,new Li({color:58879,depthTest:!1,transparent:!0,opacity:.9}));Yp.frustumCulled=!1,Yp.matrixAutoUpdate=!1,Yp.renderOrder=999,Yp.visible=!1,pp.add(Yp);var Xp=document.createElement(`div`);Xp.style.cssText=`position:fixed;pointer-events:none;z-index:10;padding:4px 8px;border-radius:4px;background:rgba(0,0,0,0.8);color:#00e5ff;font:12px/1.4 monospace;white-space:nowrap;border:1px solid rgba(0,229,255,0.5);display:none;transform:translate(12px,12px)`,document.body.appendChild(Xp);function Zp(e){let t=Jp.get(e);return t||Jp.set(e,t=new pa(e,30)),t}function Qp(e){let t=e.index?e.index.count:e.getAttribute(`position`).count;return Math.floor(t/3)}function $p(e){for(let t=e;t;t=t.parent)if(!t.visible||t.name===`snowShell`)return!1;return!0}var em=new q;function tm(){Yp.visible=!1,Xp.style.display=`none`}function nm(){if(!Wp.enabled||!qp||!xp)return tm();Gp.setFromCamera(Kp,mp);let e=Gp.intersectObject(xp,!0).find(e=>e.object.isInstancedMesh&&$p(e.object));if(!e)return tm();let t=e.object,n=t.geometry;Yp.geometry=Zp(n),t.getMatrixAt(e.instanceId,em),Yp.matrix.copy(t.matrixWorld).multiply(em),Yp.matrixWorld.copy(Yp.matrix),Yp.visible=!0,Xp.textContent=`${t.name}  •  ${Qp(n).toLocaleString()} tris  •  #${e.instanceId}`,Xp.style.display=`block`}fp.domElement.addEventListener(`pointermove`,e=>{let t=fp.domElement.getBoundingClientRect();Kp.x=(e.clientX-t.left)/t.width*2-1,Kp.y=-((e.clientY-t.top)/t.height)*2+1,qp=!0,Xp.style.left=`${e.clientX}px`,Xp.style.top=`${e.clientY}px`}),fp.domElement.addEventListener(`pointerleave`,()=>{qp=!1,tm()});var rm=new np(fp,pp,mp),im={autoOrbit:!1,orbitSpeed:.6,fov:30,letterbox:!1};hp.autoRotate=im.autoOrbit,hp.autoRotateSpeed=im.orbitSpeed,mp.fov=im.fov,mp.updateProjectionMatrix();var am=document.getElementById(`bar-top`),om=document.getElementById(`bar-bottom`);function sm(){let e=im.letterbox?`8vh`:`0`;am&&(am.style.height=e),om&&(om.style.height=e)}sm();var cm=new Ca({transparent:!0,depthWrite:!1,side:2,uniforms:{uOpacity:{value:0},uColor:{value:new J(9424895)}},vertexShader:`
    varying vec2 vUv;
  ...
  `}),lm=new ni(new ma(1,1),cm);lm.frustumCulled=!1,lm.visible=!1,pp.add(lm);var um=0,dm=new W;function fm(){um=1.2,lm.visible=!0}function pm(e){if(um<=0){lm.visible&&=!1;return}um-=e;let t=rm.bokehUniforms.focus.value;mp.getWorldDirection(dm),lm.position.copy(mp.position).addScaledVector(dm,t),lm.quaternion.copy(mp.quaternion);let n=Math.tan(At.degToRad(mp.fov/2))*t,r=n*mp.aspect;lm.scale.set(r*2*.92,n*2*.92,1),cm.uniforms.uOpacity.value=.9*Math.min(1,um/.4)}var mm=new ad({title:`hong kong building`}),hm=mm.addFolder(`building settings`);hm.add(bp,`floor`,3,40,1),hm.add(bp,`length`,2,40,1),hm.add(bp,`width`,2,40,1),hm.add(bp,`acUnit`,0,1,.01).name(`AC unit`),hm.add(bp,`roofProbability`,0,1,.01).name(`window awning`),hm.add(bp,`clothlineProbability`,0,1,.01).name(`clothline`),hm.add(bp,`windowType`,0,1,.01).name(`window type`),hm.add(bp,`windowOpenAmount`,0,1,.01).name(`window open`),hm.add(bp,`curtainClose`,0,1,.01).name(`curtain close`),hm.add(bp,`closedOpenStore`,0,1,.01).name(`open store`),hm.add(bp,`roofOnStore`,0,1,.01).name(`roof on store`),hm.add(bp,`objectOnGround`,0,1,.01).name(`ground objects`),hm.add(bp,`storeSign`,0,1,.01).name(`store sign`),hm.add(bp,`objectOnRoof`,0,1,.01).name(`roof objects`);var gm=hm.add({emissive:1},`emissive`,1,50,1).name(`emissive`).onChange(e=>yp.setFloorEmissive(e));hm.add(bp,`randomise`,0,1e3,1).name(`seed`),hm.onChange(e=>{e.controller!==gm&&Up()});var _m={enabled:!1},vm=document.createElement(`div`);vm.style.cssText=`position:fixed;top:8px;left:8px;z-index:10;padding:3px 7px;border-radius:4px;background:rgba(0,0,0,0.7);color:#7CFC00;font:12px/1.3 monospace;pointer-events:none;display:none`,document.body.appendChild(vm);var ym=performance.now(),bm=0;function xm(){if(!_m.enabled)return;bm++;let e=performance.now();e-ym>=500&&(vm.textContent=`${Math.round(bm*1e3/(e-ym))} fps`,bm=0,ym=e)}var Sm=mm.addFolder(`debug`);Sm.add(Wp,`enabled`).name(`inspect meshes`).onChange(e=>{e||tm(),fp.domElement.style.cursor=e?`crosshair`:``}),Sm.add(_m,`enabled`).name(`fps`).onChange(e=>{vm.style.display=e?`block`:`none`,e&&(ym=performance.now(),bm=0)}),Sm.close(),gp.addGui(mm);var Cm=mm.addFolder(`snow`);Cm.add(Tp,`enabled`).name(`enabled`).onChange(Op);var wm=Cm.addFolder(`snowfall`);wm.add(Tp,`density`,0,1,.01).name(`density`).onChange(e=>wp.setDensity(e)),wm.add(wp.uniforms.uSpeed,`value`,.5,12,.1).name(`fall speed`),wm.add(wp.uniforms.uSize,`value`,.01,.25,.001).name(`flake size`),wm.add(wp.uniforms.uSway,`value`,0,3,.01).name(`sway`),wm.add(wp.uniforms.uOpacity,`value`,0,1,.01).name(`opacity`),wm.addColor({c:`#ffffff`},`c`).name(`color`).onChange(e=>wp.uniforms.uColor.value.set(e)),wm.add(wp.uniforms.uVolume.value,`y`,10,80,1).name(`fall height`),wm.add(Ep,`strength`,0,25,.1).name(`wind`).onChange(Dp),wm.add(Ep,`direction`,0,360,1).name(`wind dir`).onChange(Dp),wm.close();var Tm=Cm.addFolder(`accumulation`);Tm.add(Cp.uSnowCoverage,`value`,0,1,.01).name(`coverage`),Tm.add(Cp.uSnowScale,`value`,.1,4,.01).name(`patch scale`),Tm.add(Cp.uSnowEdge,`value`,.01,.4,.005).name(`patch softness`),Tm.add(Cp.uSnowHeightVar,`value`,0,2,.01).name(`height variation`),Tm.add(Cp.uSnowSeed.value,`x`,-50,50,.1).name(`seed x`).listen(),Tm.add(Cp.uSnowSeed.value,`y`,-50,50,.1).name(`seed y`).listen(),Tm.add({randomize:()=>Cp.uSnowSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},`randomize`).name(`🎲 randomize seed`),Tm.add(Cp.uSnowFlatThreshold,`value`,0,1,.01).name(`flatness`),Tm.addColor({c:`#eaf1ff`},`c`).name(`color`).onChange(e=>Cp.uSnowColor.value.set(e)),Tm.add(Cp.uSnowRoughness,`value`,.3,1,.01).name(`roughness`),Tm.add(Cp.uSnowBump,`value`,0,1.5,.01).name(`relief strength`),Tm.add(Cp.uSnowBumpScale,`value`,.5,8,.05).name(`relief scale`),Tm.add(Cp.uSnowSparkle,`value`,0,1,.01).name(`sparkle`),Tm.add(Cp.uSnowSparkleScale,`value`,30,300,1).name(`sparkle density`),Tm.close(),Cm.close();var Em=mm.addFolder(`rain`);Em.add(Mp,`enabled`).name(`enabled`).onChange(Fp);var Dm=Em.addFolder(`rainfall`);Dm.add(Mp,`density`,0,1,.01).name(`density`).onChange(e=>jp.setDensity(e)),Dm.add(jp.uniforms.uSpeed,`value`,2,60,.5).name(`fall speed`),Dm.add(jp.uniforms.uLength,`value`,.2,4,.01).name(`streak length`),Dm.add(jp.uniforms.uWidth,`value`,.002,.05,.001).name(`streak width`),Dm.add(jp.uniforms.uOpacity,`value`,0,1,.01).name(`opacity`),Dm.addColor({c:`#b4b8bf`},`c`).name(`color`).onChange(e=>jp.uniforms.uColor.value.set(e)),Dm.add(jp.uniforms.uVolume.value,`y`,10,80,1).name(`fall height`),Dm.add(Np,`strength`,0,25,.1).name(`wind`).onChange(Pp),Dm.add(Np,`direction`,0,360,1).name(`wind dir`).onChange(Pp),Dm.close();var Om=Em.addFolder(`wetness`);Om.add(Ap.uPuddleCoverage,`value`,0,1,.01).name(`coverage`),Om.add(Ap.uPuddleScale,`value`,.02,2,.01).name(`mask scale`),Om.add(Ap.uPuddleEdge,`value`,.001,.4,.001).name(`mask softness`),Om.add(Ap.uPuddleHeightVar,`value`,0,2,.01).name(`height variation`),Om.add(Ap.uPuddleSeed.value,`x`,-50,50,.1).name(`seed x`).listen(),Om.add(Ap.uPuddleSeed.value,`y`,-50,50,.1).name(`seed y`).listen(),Om.add({randomize:()=>Ap.uPuddleSeed.value.set((Math.random()-.5)*100,(Math.random()-.5)*100)},`randomize`).name(`🎲 randomize seed`),Om.add(Ap.uWetness,`value`,0,1,.01).name(`surface wetness`),Om.add(Ap.uWaterDarkness,`value`,0,1,.01).name(`wet darkness`),Om.add(Ap.uPuddleRoughness,`value`,0,.5,.001).name(`reflection roughness`),Om.add(Ap.uDropletAmount,`value`,0,1,.01).name(`droplet beading`),Om.add(Ap.uDropletScale,`value`,2,40,.5).name(`droplet density`),Om.add(Ap.uTopPuddle,`value`,0,1,.01).name(`top puddles`),Om.add(Ap.uFlatThreshold,`value`,.2,.99,.01).name(`flatness`),Om.add(Ap.uRainRipple,`value`,0,.3,.001).name(`ripple strength`),Om.add(Ap.uRippleScale,`value`,1,20,.1).name(`ripple scale`),Om.add(Ap.uRippleSpeed,`value`,0,4,.01).name(`ripple speed`),Om.add(Ap.uRippleDensity,`value`,0,1,.01).name(`ripple density`),Om.close(),Em.close();var km=mm.addFolder(`🎬 cinematic`),Am=km.addFolder(`Camera`);Am.add(im,`autoOrbit`).name(`Auto Orbit`).onChange(e=>hp.autoRotate=e),Am.add(im,`orbitSpeed`,-3,3,.05).name(`Orbit Speed`).onChange(e=>hp.autoRotateSpeed=e),Am.add(im,`fov`,18,80,1).name(`Focal / FOV`).onChange(e=>{mp.fov=e,mp.updateProjectionMatrix()}),Am.add(im,`letterbox`).name(`Letterbox`).onChange(sm);var jm={enabled:!1},Mm=km.addFolder(`Depth of Field`);Mm.add(jm,`enabled`).name(`Enable DoF`).onChange(e=>rm.bokeh.enabled=e),Mm.add(rm.bokehUniforms.focus,`value`,0,2,.01).name(`Focus Distance`).onChange(fm),Mm.add(rm.bokehUniforms.aperture,`value`,0,.004,5e-5).name(`Aperture`),Mm.add(rm.bokehUniforms.maxblur,`value`,0,.02,5e-4).name(`Max Blur`);var Nm=km.addFolder(`Effects`);Nm.add(rm.bloom,`strength`,0,2,.01).name(`Bloom`),Nm.add(rm.bloom,`radius`,0,2,.01).name(`Bloom Radius`),Nm.add(rm.bloom,`threshold`,0,1,.01).name(`Bloom Threshold`),Nm.add(rm.gradeUniforms.uGrain,`value`,0,.25,.005).name(`Film Grain`),Nm.add(rm.gradeUniforms.uVignette,`value`,0,1.5,.01).name(`Vignette`),Nm.add(rm.gradeUniforms.uChroma,`value`,0,.01,1e-4).name(`Chromatic Aberration`),Nm.add(rm.gradeUniforms.uContrast,`value`,.7,1.6,.01).name(`Contrast`),Nm.add(rm.gradeUniforms.uSaturation,`value`,0,2,.01).name(`Saturation`),km.close();var Pm=window;Pm.__setParams=e=>{Object.assign(bp,e),mm.controllersRecursive().forEach(e=>e.updateDisplay()),Up()},Pm.__setCamera=(e,t,n,r,i,a)=>{hp.autoRotate=!1,mp.position.set(e,t,n),hp.target.set(r,i,a),hp.update()},Pm.__shot=()=>{},Pm.__debug=e=>{Lp=e,Hp(),Up()},Pm.__snow=e=>{Tp.enabled=e,Op(e),mm.controllersRecursive().forEach(e=>e.updateDisplay())},Pm.__setEnv=e=>{Object.assign(gp.settings,e),mm.controllersRecursive().forEach(e=>e.updateDisplay()),gp.refresh(),gp.frame(Ip())},yp.load(`./assets/kit.glb`,`./assets/kit_manifest.json`).then(()=>{document.getElementById(`loading`)?.remove(),up(yp.materials.building,Ap),up(yp.materials.floor,Ap),Up(),mp.position.set(9,5.5,11),hp.target.set(0,3,0),hp.update()}).catch(e=>{let t=document.getElementById(`loading`);t&&(t.textContent=`FAILED TO LOAD KIT: ${e}`),console.error(e)}),addEventListener(`resize`,()=>{mp.aspect=innerWidth/innerHeight,mp.updateProjectionMatrix(),fp.setSize(innerWidth,innerHeight),rm.setSize(innerWidth,innerHeight)});var Fm=new ts;fp.setAnimationLoop(()=>{let e=Math.min(Fm.getDelta(),.1);hp.update(),mp.position.y<.2&&(mp.position.y=.2),gp.tick(),Tp.enabled&&(Sp.uTime.value+=e,wp.update()),Mp.enabled&&(kp.uTime.value+=e,jp.update()),pm(e),nm(),xm(),rm.render(e)});